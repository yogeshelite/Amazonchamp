...
namespace Amazonweb
{
    ...
    {
        public static string ApiUrl =>string.Format("{0}/{1}",(ConfigurationManager.AppSettings["IsTest"].Equals("1") ) ? "http://localhost:49938" : "http://localhost:49938",  Properties.Settings.Default.ApiUrl);
        #region Api Response
