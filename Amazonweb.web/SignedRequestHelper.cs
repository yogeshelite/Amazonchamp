...
namespace Amazonweb
{
    public class SignedRequestHelper
    {
        ...
        private string AwsAccessKeyId { get; set; } = Properties.Settings.Default.AWS_ACCESS_KEY_ID;
        private string AwsSecretKey { get; set; } = Properties.Settings.Default.AWS_SECRET_KEY;
        public string  AwswebserviceUrl  { get; set; } = Properties.Settings.Default.AWS_SERVICE_URL;
        //
        ...
        {
            this.endPoint = AwswebserviceUrl.ToLower();
