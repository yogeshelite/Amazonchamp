...
function GetUserAbout(userIdPram) {
    ...
    //console.log(userIdPram + '/Template4Controller/GetProductASIN');
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var logoImg = '<img src="/' + userIdPram + '../../Doc/' + result.AttachmentLogoName + '" width="50" />';
   ...
   // var userId = "1E424621-6402-4ECC-870E-83D76BCF6739";
    $.ajax({
        ...
        success: function (result) {
           ...
           console.log(TempCtr);
           return TempCtr;
          //     TempAction: result.TempAction,
           //     TempCtr: result.Controller
           //}
        }
    });
}
   ...
   var userids = "1E424621-6402-4ECC-870E-83D76BCF6739";
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //console.log(userIdPram + '/' + GetRoute+'/Template1Controller/GetProductASIN');
